...
export default function EditorPage() {
  ...
  const handleExportPDF = async () => {
    ...
    try {
      ...
      setNotificationMessage("✅ Resume downloaded successfully!");
      setShowNotification(true);
    } catch (err) {
      console.error("Export error:", err);
      setNotificationMessage("❌ Export failed: " + (err?.message || "Please try again."));
      setShowNotification(true);
    } finally {
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="bg-white overflow-hidden pdf-render-target">
